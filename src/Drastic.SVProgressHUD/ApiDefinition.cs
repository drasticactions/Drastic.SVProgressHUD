...
namespace Drastic.SVProgressHUD
{
    ...
    interface SVProgressHUD
    {
        ...
        // @property (nonatomic, strong) UI_APPEARANCE_SELECTOR UIFont * font __attribute__((annotate("ui_appearance_selector")));
        [Export("font", ArgumentSemantic.Strong)]
        UIFont Font { get; set; }

        // @property (nonatomic, strong) UI_APPEARANCE_SELECTOR UIColor * backgroundColor __attribute__((annotate("ui_appearance_selector")));
        [Export("backgroundColor", ArgumentSemantic.Strong)]
        UIColor BackgroundColor { get; set; }

        // @property (nonatomic, strong) UI_APPEARANCE_SELECTOR UIColor * foregroundColor __attribute__((annotate("ui_appearance_selector")));
        [Export("foregroundColor", ArgumentSemantic.Strong)]
        UIColor ForegroundColor { get; set; }

        // @property (nonatomic, strong) UI_APPEARANCE_SELECTOR UIColor * foregroundImageColor __attribute__((annotate("ui_appearance_selector")));
        [Export("foregroundImageColor", ArgumentSemantic.Strong)]
        UIColor ForegroundImageColor { get; set; }

        // @property (nonatomic, strong) UI_APPEARANCE_SELECTOR UIColor * backgroundLayerColor __attribute__((annotate("ui_appearance_selector")));
        ...
        [Export("shouldTintImages")]
        bool ShouldTintImages { get; set; }

        // @property (nonatomic, strong) UI_APPEARANCE_SELECTOR UIImage * infoImage __attribute__((annotate("ui_appearance_selector")));
        [Export("infoImage", ArgumentSemantic.Strong)]
        UIImage InfoImage { get; set; }

        // @property (nonatomic, strong) UI_APPEARANCE_SELECTOR UIImage * successImage __attribute__((annotate("ui_appearance_selector")));
        [Export("successImage", ArgumentSemantic.Strong)]
        UIImage SuccessImage { get; set; }

        // @property (nonatomic, strong) UI_APPEARANCE_SELECTOR UIImage * errorImage __attribute__((annotate("ui_appearance_selector")));
        [Export("errorImage", ArgumentSemantic.Strong)]
        UIImage ErrorImage { get; set; }

        // @property (nonatomic, strong) UI_APPEARANCE_SELECTOR UIView * viewForExtension __attribute__((annotate("ui_appearance_selector")));
        ...
        [Export("motionEffectEnabled")]
        bool MotionEffectEnabled { get; set; }
        ...
        // +(void)setForegroundImageColor:(UIColor * _Nullable)color;
        [Static]
        [Export("setForegroundImageColor:")]
        void SetForegroundImageColor([NullAllowed] UIColor color);
        ...
        // +(void)setHudViewCustomBlurEffect:(UIBlurEffect * _Nullable)blurEffect;
        [Static]
        [Export("setHudViewCustomBlurEffect:")]
        void SetHudViewCustomBlurEffect([NullAllowed] UIBlurEffect blurEffect);
